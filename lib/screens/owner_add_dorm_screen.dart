...
class OwnerAddDormScreen extends ConsumerStatefulWidget {
  const OwnerAddDormScreen({super.key});

  @override
  ConsumerState<OwnerAddDormScreen> createState() => _OwnerAddDormScreenState();
}

class _OwnerAddDormScreenState extends ConsumerState<OwnerAddDormScreen> {
        ...
        body: stackedLoadingContainer(
            ...
            SingleChildScrollView(
              ...
              child: Column(
                children: [
                  _backButton(),
                  blackInterBold('ADD DORM', fontSize: 36),
                  _dormFields(),
                  _submitButton()
                ],
              ),
  ...
  Widget _dormFields() {
    return Container(
        decoration:
            BoxDecoration(color: CustomColors.murkyGreen, border: Border.all()),
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                proofOfOwnershipUploadWidget(context, ref),
                proofOfAccreditationUploadWidget(context, ref)
              ],
            )
          ],
        ));
  ...
  Widget _submitButton() {
    return vertical20Pix(
        child: ElevatedButton(
            ...
            child: whiteInterBold('ADD NEW DORM')));
  }
}
