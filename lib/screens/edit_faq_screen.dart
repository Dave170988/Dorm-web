...
class _EditFAQScreenState extends ConsumerState<EditFAQScreen> {
  ...
  Widget _backButton() {
    return vertical20Pix(
      child: Row(children: [
        ElevatedButton(
            onPressed: () => GoRouter.of(context).goNamed(GoRoutes.faqs),
  ...
  Widget _questionWidget() {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      vertical10Pix(child: blackInterBold('Question', fontSize: 24)),
      CustomTextField(
          text: 'Question',
  ...
  Widget _answerWidget() {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      vertical10Pix(child: blackInterBold('Answer', fontSize: 24)),
      CustomTextField(
          text: 'Answer',
